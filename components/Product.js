...
const Product = ({ titleProduct, description, imgSrc, id, alt }) => {
    return (
        <div className="bg-gray-50 pt-6">
            <div className="w-9/12 flex justify-between mx-auto ">
                <div className=" w-6/12 bg-gray-50 flex justify-start">
                    <Image src={imgSrc} width='600' height={'400'} alt={alt} />
                </div>
                <div className="w-6/12 bg-gray-50 flex flex-col justify-center ">
                    ...
                    <div className="pl-5 text-gray-700 text-justify h-80 pt-5 text-wrap max-lines ">{description}</div>
